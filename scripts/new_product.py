...
def render_makefile(product_kebab: str, provider: str = PROVIDER_GOOGLE_SHEETS) -> str:
...
def scaffold(
    ...
    files: list[tuple[str, str]] = [
        ...
        ("backend/apps/core/models_auto.py", "# Auto-generated by make new-product. Populated by make generate-models.\n"),
        ("backend/apps/core/migrations/__init__.py", ""),
        ("pyproject.toml", render_pyproject_toml(product_kebab, py_name)),
        ("Makefile", render_makefile(product_kebab, provider)),
    ...
    copy_file(
        script_dir.parent / "AUTONOMOUS_RUN_PROMPT.md",
        output_dir / "AUTONOMOUS_RUN_PROMPT.md",
        force=force,
    )
