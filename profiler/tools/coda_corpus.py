...
def run_coda_corpus(
    *,
    ...
    .. note::
       ...
       This function now delegates to :class:`CodaCorpusAdapter` for the
       actual pipeline execution.  It is kept here for backward compatibility;
